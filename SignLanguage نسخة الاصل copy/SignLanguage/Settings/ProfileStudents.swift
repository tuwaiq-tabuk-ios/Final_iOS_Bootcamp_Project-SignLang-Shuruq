...
class ProfileStudents: UIViewController{
 ...
 setupContextMenu()
  ...
  @IBAction func editePassword(_ sender: Any) {
    ...
    let storyBoard : UIStoryboard = UIStoryboard(name: "Main", bundle:nil)
    let nextViewController2 = storyBoard.instantiateViewController(withIdentifier: "EditeProfile") as! EditePassword
...
extension ProfileStudents : UIContextMenuInteractionDelegate {
  ...
  extension ProfileStudents:UIImagePickerControllerDelegate ,UINavigationControllerDelegate {
